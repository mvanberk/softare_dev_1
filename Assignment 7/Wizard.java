public class Wizard extends Enemy{
    ...
    void damageType(Enemy target) {
        if (type == "fire") {
            ...
            System.out.println(name + " casts Fireball and inflicts " + 2*damage + " fire damage to " + target.name + "!");
        ...
        if (type == "ice") {
            ...
            System.out.println(name + " casts Cone of Cold and inflicts " + 2*damage + " ice damage to " + target.name + "!");
            target.health = target.health - 2*damage;
            if (target.health <= 0) {
